...
<body class="main">
    ...
    <fieldset id="fieldset" style="height:400px ">
        <legend style="font-size:15px" > Asset Register</legend>    
        <form onsubmit="validate()" style="background-color: transparent" action="AssetREg.htm" method="POST"  modelAttribute="assetreg" >
            <table class="gridLayout" cellpadding="10"  cellspacing="15">
                ...
                <tr>
                    ...
                    <td><input type="text" class="c_dmy cal_img" id="doi" name="doi"></td>
                </tr>
                <tr>
                    <td align="center" colspan="4" ><input value="Submit" type="submit"></td>
                </tr>
            </table> 
        </form>
    </fieldset>
